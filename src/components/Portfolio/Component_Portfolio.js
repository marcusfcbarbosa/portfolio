                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                        ...
                                        <figure className="cc-effect">
                                            <img src={require('../../images/project-1.jpg')} alt="Image"  />
                                            <figcaption>
                                    ...
                                    <div className="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                        <a href="#web-development">
                                        <figure className="cc-effect">
                                            <img src={require('../../images/project-2.jpg')} alt="Image"  />
                                            <figcaption>
                                ...
                                <div className="col-md-6">
                                    <div className="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                        <a href="#web-development">
                                        <figure className="cc-effect">
                                            <img src={require('../../images/project-3.jpg')} alt="Image"  />
                                            <figcaption>
                                    ...
                                    <div className="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                                        <a href="#web-development">
                                        <figure className="cc-effect">
                                            <img src={require('../../images/project-4.jpg')} alt="Image"  />
                                            <figcaption>
