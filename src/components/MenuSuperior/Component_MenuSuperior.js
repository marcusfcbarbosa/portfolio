...
class  Component_MenuSuperior extends Component{
                            ...
                            <header>
                                ...
                                <nav className="navbar navbar-expand-lg fixed-top navbar-transparent bg-primary" color-on-scroll="400">
                                    <div className="container">
                                        <div className="navbar-translate"><a className="navbar-brand" href="#" rel="tooltip">MY PORTFOLIO</a>
...
export default Component_MenuSuperior;